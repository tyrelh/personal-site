  ...
  render() {
    return (
      <div className="article">
        ...
        <h3 datatext={this.state.title}>
          <span className="underline">{this.state.title}</span>
        </h3>
        </section>
        <section className="fadeIn">
        ...
        <section className="fadeIn" id="background">
          ...
          <div className="image">
            <img src={whitefox} alt="whitefox mechanical keyboard" />
          </div>
          <p>
        ...
        <section className="fadeIn" id="design">
          ...
          <div className="image">
            <img src={layoutImg} alt="keyboard layout drawing" />
          </div>
          <p>
          ...
          <div className="image">
            <img src={keycapsImg} alt="keycaps" />
          </div>
          <p>
          ...
          <div className="image">
            <img src={testImg} alt="teensy microcontroller test with mechanical switches" />
          </div>
          <p>
        ...
        <section className="fadeIn" id="construction">
          ...
          <div className="image">
            <img src={pcbImg1} alt="assembling the individual breakout boards" />
          </div>
          <div className="image">
            <img src={pcbImg2} alt="full keyboard pcb glued together" />
          </div>
          <p>
          ...
          <div className="image">
            <img src={pcbImg3} alt="jumper wires to connect the breakout boards" />
          </div>
          <div className="image">
            <img src={pcbImg4} alt="completed circut board all soldered together" />
          </div>
          <p>
          ...
          <div className="image">
            <img src={programmingImg1} alt="top view of intitial wiring to the controller" />
          </div>
          <div className="image">
            <img src={programmingImg2} alt="bottom view of initial wireing to the controller" />
          </div>
        </section>
        ...
        <section className="fadeIn" id="programming">
          ...
          <div className="image">
            <img src={ideImg} alt="change the teensy to behave like a keyboard in the arduino IDE" />
          </div>
          <p>
        ...
        <section className="fadeIn" id="update1">
          ...
          <div className="image">
            <img src={caseImg1} alt="top view of keyboard with new acrylic case and LEDs gliwing purple" />
          </div>
          <div className="image">
            <img src={caseImg2} alt="angle view of keyboard with new acrylic case and LEDs gliwing purple" />
          </div>
          <p>
